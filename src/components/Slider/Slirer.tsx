  ...
  return (
    ...
    <Carousel useKeyboardArrows = {true} interval={1000}>
                ...
                <div className={style.slide}>
                    ...
                    <div className={style.textArea}>
                        <p>В одном из топовых заведений невероятно красивого города Кимры официант принес мой заказ с бургером, в котором я обнаружила торчащий из него волос.</p>
                        ...
                        <p>Я немедленно обратилась к официанту со словами: &quot;Вы знаете, кто я такая? Я знаю свои права!&quot; - и потребовала заменить бургой на другой. </p>
                        ...
                        <p>Кстати, по соседству сидящему классному парню Денису, заказавшему такой же бургер, заказ принесли спустя минуту после этого проишествия. Нет сомнений в том, что в его заказе был тот самый бургер, но уже с извлеченным волосом и подогретый в микроволновке.</p>
                        <p>*Интересно, догадался ли он об этом или был слишком занят наслаждением от нахождения в компании с обаятельным юристом?</p>
                    </div>
                </div>
            </Carousel>
    </div>
